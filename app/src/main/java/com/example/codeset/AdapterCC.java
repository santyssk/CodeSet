...
public class AdapterCC extends RecyclerView.Adapter<AdapterCC.MyViewHolder> {
    ...
    private ArrayList<ProblemCC> problems;
    private Context context;

    public AdapterCC(Context context, ArrayList<ProblemCC> problems){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.problem_card_cc,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ProblemCC problem = problems.get(position);
